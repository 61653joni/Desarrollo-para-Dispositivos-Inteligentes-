// sw.js
const CACHE_STATIC  = 'clima-tv-static-v4';
const CACHE_DYNAMIC = 'clima-tv-dynamic-v4';
...
async function cacheFirst(request) {
  ...
  // Las respuestas parciales (206, de peticiones Range en <video>)
  // no pueden guardarse en Cache Storage
